...
export default function PublicationToReaction({ id_post, like_usuario_actual, likes, comentario_count, props }: { id_post: number, like_usuario_actual: boolean, likes: number, comentario_count: number, props: any }) {
  const { setItemSelec, setItemPost } = usePostStore()
  ...
  return (
    <>
      <div className="w-full flex gap-4 items-center justify-between">
        ...
        <button className="flex gap-2 items-center px-4 text-gray-400 justify-center cursor-pointer hover:bg-[#4EB8E933] p-2 rounded-full" onClick={() => { setItemSelec(id_post); setShowModal(true), setItemPost(props) }}>
