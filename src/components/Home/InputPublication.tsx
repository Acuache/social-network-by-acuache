...
import { useUsuariosStore, usePostStore } from '../../store'
...
export default function InputPublication() {
  ...
  return (
    <div className="p-4 border-b border-gray-200 dark:border-gray-600">
      <div className="dark:bg-[#252728] dark:hover:bg-[#484849] text-md text-[#b8bbbf] p-2 rounded-full px-5 cursor-pointer transition-colors duration-300" onClick={setStateForm}>
